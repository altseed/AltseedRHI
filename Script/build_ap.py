...
with aceutils.CurrentDir('../Downloads'):
	...
	aceutils.copytreeWithExt(r'AltseedPlatform/include/', r'../include/',['.h'])
	aceutils.copytreeWithExt(r'AltseedPlatform/lib/', r'../lib/',['.lib','.a'])
	...
	if aceutils.isWin():
		...
		aceutils.copy(r'AltseedPlatform_bin/src/Debug/AltseedPlatform.lib', r'../lib/x86/Debug/')
		aceutils.copy(r'AltseedPlatform_bin/src/Release/AltseedPlatform.lib', r'../lib/x86/Release/')
		aceutils.copy(r'AltseedPlatform_bin_x64/src/Debug/AltseedPlatform.lib', r'../lib/x64/Debug/')
