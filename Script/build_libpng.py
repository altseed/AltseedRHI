...
if aceutils.isWin():
	...
	if aceutils.isMac():
		aceutils.call(r'cmake -G "Unix Makefiles" -D BUILD_SHARED_LIBS:BOOL=OFF -D CMAKE_INSTALL_PREFIX=../dev "-DCMAKE_OSX_ARCHITECTURES=x86_64;i386" ../zlib/')
	else:
		aceutils.call(r'cmake -G "Unix Makefiles" -D BUILD_SHARED_LIBS:BOOL=OFF -D CMAKE_INSTALL_PREFIX=../dev ../zlib/')
	...
	if aceutils.isMac():
		...
		aceutils.call(r'cmake -G "Unix Makefiles" -D PNG_STATIC:BOOL=ON -D CMAKE_INSTALL_PREFIX=../dev "-DCMAKE_OSX_ARCHITECTURES=x86_64;i386" ../libpng/')
	else:
		aceutils.call(r'cmake -G "Unix Makefiles" -D BUILD_SHARED_LIBS:BOOL=OFF -D CMAKE_INSTALL_PREFIX=../dev ../libpng/')
	aceutils.call(r'make install')
	aceutils.cd(r'../')
